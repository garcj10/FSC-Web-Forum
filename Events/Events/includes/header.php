...
?>
    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
        ...
        <div class="container-fluid" style="background-color:#006f71">
            ...
            <li><a href="dashboard.php" style="color: #f3f3f3">My Dashboard</a></li>  <li><a href="my_account.php" style="color: #f3f3f3">My Account</a></li>
                    <li><a href="includes/logout.php" style="color: #f3f3f3">Sign out</a></li>
            </ul> 
            </div>
        </div>
    </nav>
