...
<?php   if(isset($_SESSION['is_Student'])) { ?> 
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="ramID" name="ramID" class="form-control" id="ramID" placeholder="Enter RAM ID" required>
            </div>
          </div>
          ...
          <div class="form-group">
             ...
             <div class="col-sm-10">
              <input type="major" name="major" class="form-control" id="major" placeholder="Enter Major" required>
            </div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="collegeLevel" name="collegeLevel" class="form-control" id="collegeLevel" placeholder="Enter Year of Study" required>
            </div>
          </div>
...
<?php } else ?>
 ...
 <?php   if(isset($_SESSION['is_Faculty'])) { ?> 
          ...
          <div class="form-group">
             ...
             <div class="col-sm-10">
              <input type="department" name="department" class="form-control" id="department" placeholder="Enter Department" required>
            </div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="occupation" name="occupation" class="form-control" id="occupation" placeholder="Enter Occupation" required>
            </div>
          </div>
