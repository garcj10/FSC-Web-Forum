...
//while($row = $result->fetch_assoc()){
   foreach($row as $event)
    ...
    <div class="form-group"><button type="submit" action="see_events.php" name="signup" class="btn btn-link"><a href="includes/event_registry.php?event_id=<?php echo $event["event_Id"] ?>"/>Register</button></div>
